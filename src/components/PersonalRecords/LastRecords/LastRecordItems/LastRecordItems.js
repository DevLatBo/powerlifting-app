        ...
        items = recordItems.map((recordItem) => {
            return (
                <TableRow key={recordItem.id}>
                    <TableCell align="center"><strong>{recordItem.id}</strong></TableCell>
                    <TableCell align="center">{recordItem.weight}</TableCell>
                    <TableCell align="center">{recordItem.repetition}</TableCell>
